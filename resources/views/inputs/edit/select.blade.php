        ...
        @else
            ...
            <div class="input-group">
                <input id="{{ $name_no_dot }}-search" name="{{ $name_no_dot }}-search" class="form-control"
                    type="text" autocomplete="off" list="{{ $name_no_dot }}_the_arr" onfocus="this.value=''"
                    onchange="on{{ $name_no_dot }}ChangeSearch(event)" placeholder="{{ $value }}"
                    value="{{ $value }}">
                <datalist id="{{ $name_no_dot }}_the_arr">
                    <option data-value="" value="All"></option>
                    @foreach ($arr as $obj)
