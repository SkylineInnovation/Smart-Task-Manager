    ...
    <div class="card ">
        ...
        <div class="card-body">
            <div class="row w-100 m-0">
                @permission('task-omments-report')
                ...
                @endpermission
                @permission('closed-tasks-coming-soon')
                    <div class="col-md-2  d-flex justify-content-center">
                ...
                @permission('outgoing-task-movements')
                    <div class="col-md-2  d-flex justify-content-center">
                ...
                @permission('incoming-task-movements')
                    <div class="col-md-2  d-flex justify-content-center">
                ...
                @permission('outgoing-task-discounts')
                    <div class="col-md-2  d-flex justify-content-center">
                ...
                @permission('follow-up-employee-tasks')
                    <div class="col-md-2  d-flex justify-content-center">
