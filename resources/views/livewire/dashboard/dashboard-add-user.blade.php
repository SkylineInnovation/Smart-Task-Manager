<div class="col-md-3 col-6 mb-4 d-flex text-center justify-content-center ">
    <a wire:click="get_create_date()" href="#" data-toggle="modal" data-target="#create-new-user-modal"
    ...
    @permission('create-user')
        <!-- Modal -->
        <div wire:ignore.self class="modal fade text-start" id="create-new-user-modal" data-backdrop="static"
            data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="create-new-user-modal-label"
            aria-hidden="true">
