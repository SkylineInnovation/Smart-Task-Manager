...
use App\Exports\Comment\FullCommentsExport;
use App\Imports\Comment\FullCommentsImport;
...
class CommentController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.comment.comment-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'comments-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullCommentsExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullCommentsImport, $request->excel_file);
        }
