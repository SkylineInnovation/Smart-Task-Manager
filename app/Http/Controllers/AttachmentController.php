...
use App\Exports\Attachment\FullAttachmentsExport;
use App\Imports\Attachment\FullAttachmentsImport;
...
class AttachmentController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.attachment.attachment-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'attachments-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullAttachmentsExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullAttachmentsImport, $request->excel_file);
        }
