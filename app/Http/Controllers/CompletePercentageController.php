...
use App\Exports\CompletePercentage\FullCompletePercentagesExport;
use App\Imports\CompletePercentage\FullCompletePercentagesImport;
...
class CompletePercentageController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.completepercentage.completepercentage-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'completepercentages-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullCompletePercentagesExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander'){
            Excel::import(new FullCompletePercentagesImport, $request->excel_file);
        }
