...
use App\Exports\Work\FullWorksExport;
use App\Imports\Work\FullWorksImport;
...
class WorkController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.work.work-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'works-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullWorksExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullWorksImport, $request->excel_file);
        }
