...
class TaskController extends Controller
{
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'tasks-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullTasksExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullTasksImport, $request->excel_file);
        }
