...
use App\Exports\PasswordCode\FullPasswordCodesExport;
use App\Imports\PasswordCode\FullPasswordCodesImport;
...
class PasswordCodeController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.passwordcode.passwordcode-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'passwordcodes-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullPasswordCodesExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander'){
            Excel::import(new FullPasswordCodesImport, $request->excel_file);
        }
