...
use App\Exports\Company\FullCompanysExport;
use App\Imports\Company\FullCompanysImport;
use App\Models\Company;
...
class CompanyController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.company.company-home', compact('admin_view_status'));
    }

    public function livewireShow(Company $company)
    {
        return view('pages.crud.company.company-show', compact('company'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'companies-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullCompanysExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullCompanysImport, $request->excel_file);
        }
