...
use App\Exports\LogHistory\FullLogHistorysExport;
use App\Imports\LogHistory\FullLogHistorysImport;
...
class LogHistoryController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.loghistory.loghistory-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'loghistories-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullLogHistorysExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullLogHistorysImport, $request->excel_file);
        }
