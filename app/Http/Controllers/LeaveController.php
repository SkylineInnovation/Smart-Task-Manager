...
use App\Exports\Leave\FullLeavesExport;
use App\Imports\Leave\FullLeavesImport;
...
class LeaveController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.leave.leave-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'leaves-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullLeavesExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullLeavesImport, $request->excel_file);
        }
