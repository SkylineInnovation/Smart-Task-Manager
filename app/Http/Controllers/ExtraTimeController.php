...
use App\Exports\ExtraTime\FullExtraTimesExport;
use App\Imports\ExtraTime\FullExtraTimesImport;
...
class ExtraTimeController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.extratime.extratime-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'extratimes-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullExtraTimesExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullExtraTimesImport, $request->excel_file);
        }
