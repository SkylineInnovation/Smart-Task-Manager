...
use App\Exports\UserDetail\FullUserDetailsExport;
use App\Imports\UserDetail\FullUserDetailsImport;
...
class UserDetailController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.userdetail.userdetail-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'userdetails-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullUserDetailsExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullUserDetailsImport, $request->excel_file);
        }
