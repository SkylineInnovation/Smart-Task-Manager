...
use App\Exports\DeviceTokenList\FullDeviceTokenListsExport;
use App\Imports\DeviceTokenList\FullDeviceTokenListsImport;


class DeviceTokenListController extends Controller
{
    public function livewireIndex()
    {
        $admin_view_status = 'all';
        return view('pages.crud.devicetokenlist.devicetokenlist-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'devicetokenlists-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullDeviceTokenListsExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander'){
            Excel::import(new FullDeviceTokenListsImport, $request->excel_file);
        }
