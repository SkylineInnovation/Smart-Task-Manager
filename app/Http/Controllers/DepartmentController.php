...
use App\Exports\Department\FullDepartmentsExport;
use App\Imports\Department\FullDepartmentsImport;
...
class DepartmentController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.department.department-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'departments-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullDepartmentsExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullDepartmentsImport, $request->excel_file);
        }
