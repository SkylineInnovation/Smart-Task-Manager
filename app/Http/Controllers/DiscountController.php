...
use App\Exports\Discount\FullDiscountsExport;
use App\Imports\Discount\FullDiscountsImport;
...
class DiscountController extends Controller
{
    public function livewireIndex()
    {
        ...
        return view('pages.crud.discount.discount-home', compact('admin_view_status'));
    }
    ...
    public function exportFullData(Request $request)
    {
        ...
        $name = 'discounts-' . date('Y-m-d') . $extension;
        ...
        return Excel::download(new FullDiscountsExport($by_date, $from_date, $to_date), $name);
    }
    ...
    public function importData(Request $request)
    {
        ...
        if ($import_type == 'stander') {
            Excel::import(new FullDiscountsImport, $request->excel_file);
        }
